...
movie_annoy_index = setup_annoy_index(movie_data, "models/movie_index.ann", "genres")

netflix_data, netflix_ids = load_netflix_data()
netflix_annoy_index = setup_annoy_index(netflix_data, "models/netflix_index.ann", "text_features")
